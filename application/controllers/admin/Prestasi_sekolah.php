...
class Prestasi_sekolah extends CI_Controller {
	...
	{	
		...
		}else
		{
  		...
  		$this->template->admin('admin/dashboard','admin/prestasi/prestasi_sekolah',$data);
    }
        ...
        foreach($list as $r)
        {
            ...
            if($r->gambar != '' AND file_exists($target))
            {
				$img = '<a href="'.base_url("assets/img/prestasi/sekolah/$r->gambar").'" target="_blank">
						<img src="'.base_url("assets/img/prestasi/sekolah/$r->gambar").'" class="img img-fluid"></a>'; 
            }else
            {
				$img = '';
			}
			...
			$action = '<div class="text-center">
						<a href="'.base_url("backend/edit-prestasi-sekolah/$r->id").'" class="btn btn-dark btn-xs btn-flat" title="EDIT DATA">EDIT</a>
	...
	{ 
		...
		$this->template->admin('admin/dashboard','admin/prestasi/form_tambah_prestasi_sekolah',$data);
    }
	...
	{ 
        ...
        }else
        {
            ...
            $this->template->admin('admin/dashboard','admin/prestasi/form_edit_prestasi_sekolah',$data);
        }        
    }
