...
class Siswa extends CI_Controller {
	...
	{	
        ...
        $data['data'] = $this->siswa_model->tampil_siswa();
  		$this->template->admin('admin/dashboard','admin/siswa/siswa', $data);
	}
	...
	{ 
		...
		$this->template->admin('admin/dashboard','admin/siswa/form_tambah_siswa',$data);
	}
	...
	{ 
        ...
        }else
        {
			...
			$data['profil'] = $this->db->select('id,jenjang')->from('tb_profil')->where('id',1)->get()->row();
			$this->template->admin('admin/dashboard','admin/siswa/form_edit_siswa',$data);
		}
	}
