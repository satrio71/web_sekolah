...
class Agenda extends CI_Controller {
	...
	{	
		$data['title'] = 'Agenda';
  		$this->template->admin('admin/dashboard','admin/agenda/agenda', $data);
	}
        ...
        foreach($list as $r)
        {
            ...
            if($r->gambar != '' AND file_exists("assets/img/agenda/$r->gambar"))
            {
				$img = '<a href="'.base_url("assets/img/agenda/$r->gambar").'" target="_blank">
							<img src="'.base_url("assets/img/agenda/$r->gambar").'" class="img img-fluid">
						</a>'; 
            }else
            {
				$img = '';
			...
			$action = '<div class="text-center">
						<a href="'.base_url("backend/edit-agenda/$r->id").'" class="btn btn-dark btn-xs btn-flat" title="EDIT DATA">EDIT</a>
	...
	{ 
		...
		$this->template->admin('admin/dashboard','admin/agenda/form_tambah_agenda',$data);
    }
	...
	{ 
		...
		$this->template->admin('admin/dashboard','admin/agenda/form_edit_agenda',$data);
    }
