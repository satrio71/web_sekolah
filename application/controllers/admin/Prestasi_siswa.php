...
class Prestasi_siswa extends CI_Controller {
	...
	{	
		$data['title'] = 'Prestasi Siswa';
  		$this->template->admin('admin/dashboard','admin/prestasi/prestasi_siswa',$data);
    }
        ...
        foreach($list as $r)
        {
            ...
            if($r->gambar != '' AND file_exists($target))
            {
				$img = '<a href="'.base_url("assets/img/prestasi/siswa/$r->gambar").'" target="_blank">
						<img src="'.base_url("assets/img/prestasi/siswa/$r->gambar").'" class="img img-fluid"></a>'; 
            }else
            {
				$img = '';
			}
			...
			$action = '<div class="text-center">
						<a href="'.base_url("backend/edit-prestasi-siswa/$r->id").'" class="btn btn-dark btn-xs btn-flat" title="EDIT DATA">EDIT</a>
	...
	{ 
		...
		$this->template->admin('admin/dashboard','admin/prestasi/form_tambah_prestasi_siswa',$data);
    }
	...
	{ 
        ...
        }else
        {
            ...
            $this->template->admin('admin/dashboard','admin/prestasi/form_edit_prestasi_siswa',$data);
        }        
    }
