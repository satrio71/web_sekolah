...
class User extends CI_Controller {
	...
	{	
        if($this->session->userdata('level') == 'superadmin')
        {
			...
			$data['title'] = 'Users';
			$this->template->admin('admin/dashboard','admin/user/users', $data);
        }else
        {
			show_404();
		}
	...
	{ 	
        if($this->session->userdata('level') == 'superadmin')
        {
			...
			$this->template->admin('admin/dashboard','admin/user/form_tambah_user',$data);
        }else
        {
			show_404();
		}
	...
	{ 	
        if($this->session->userdata('level') == 'superadmin')
        {
			...
			$this->template->admin('admin/dashboard','admin/user/form_edit_user',$data);
        }else
        {
			show_404();
		}
	...
	{ 	
        ...
        }else
        {
            ...
            $data['data'] = $this->db->get_where('tb_user',['id_user'=>$id])->row();
            $this->template->admin('admin/dashboard','admin/user/form_edit_profil',$data);
        }
    }
	...
	{ 
		...
		$this->template->admin('admin/dashboard','admin/user/gantipass',$data);
    }
