...
class Prestasi_guru extends CI_Controller {
	...
	{	
		$data['title'] = 'Prestasi Guru';
  		$this->template->admin('admin/dashboard','admin/prestasi/prestasi_guru',$data);
    }
        ...
        foreach($list as $r)
        {
            ...
            if($r->gambar != '' AND file_exists($target))
            {
				$img = '<a href="'.base_url("assets/img/prestasi/guru/$r->gambar").'" target="_blank">
						<img src="'.base_url("assets/img/prestasi/guru/$r->gambar").'" class="img img-fluid"></a>'; 
            }else
            {
				$img = '';
			}
			...
			$action = '<div class="text-center">
						<a href="'.base_url("backend/edit-prestasi-guru/$r->id").'" class="btn btn-dark btn-xs btn-flat" title="EDIT DATA">EDIT</a>
	...
	{ 
		...
		$this->template->admin('admin/dashboard','admin/prestasi/form_tambah_prestasi_guru',$data);
    }
	...
	{ 
        ...
        }else
        {
            ...
            $this->template->admin('admin/dashboard','admin/prestasi/form_edit_prestasi_guru',$data);
        }        
    }
