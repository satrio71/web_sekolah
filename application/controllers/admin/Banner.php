...
class Banner extends CI_Controller {
	...
	{	
        $data['title'] = 'Banner Web';
  		$this->template->admin('admin/dashboard','admin/banner/banner', $data);
    }
        ...
        {	
            ...
            if($r->gambar != '' AND file_exists($target))
            {
				$img = '<a href="'.base_url("assets/img/banner/$r->gambar").'" target="_blank">
						<img src="'.base_url("assets/img/banner/$r->gambar").'" class="img img-fluid"></a>'; 
			}else{
				$img = '';
			}
			...
			$action = '<div class="text-center">
						<a href="'.base_url("backend/edit-banner/$r->id").'" class="btn btn-dark btn-xs btn-flat" title="EDIT DATA">EDIT</a>
	...
	{ 
		...
		$this->template->admin('admin/dashboard','admin/banner/form_tambah_banner',$data);
    }
	...
	{ 
		...
		$this->template->admin('admin/dashboard','admin/banner/form_edit_banner',$data);
    }
