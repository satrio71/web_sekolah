...
class Pengumuman extends CI_Controller {
	...
	{	
		$data['title'] = 'Pengumuman';
  		$this->template->admin('admin/dashboard','admin/pengumuman/pengumuman', $data);
	}
        ...
        foreach($list as $r)
        {
            ...
            if($r->gambar!='' AND file_exists("assets/img/pengumuman/$r->gambar"))
            {
				$img = '<a href="'.base_url("assets/img/pengumuman/$r->gambar").'" target="_blank">
						<img src="'.base_url("assets/img/pengumuman/$r->gambar").'" class="img img-fluid"></a>'; 
            }else
            {
				$img = '';
			}
			...
			{	
				$aksi = '<div class="text-center">
							<a href="'.base_url("backend/edit-pengumuman/$r->id").'" class="btn btn-dark btn-xs btn-flat" title="EDIT DATA">EDIT</a>
	...
	{ 
		...
		$this->template->admin('admin/dashboard','admin/pengumuman/form_tambah_pengumuman',$data);
    }
	...
	{   
		...
		$this->template->admin('admin/dashboard','admin/pengumuman/form_edit_pengumuman',$data);
    }
