...
class Alumni_model extends CI_Model {
    ...
    private $column_order = array(null, 'status','nama','th_lulus','instansi','alamatins','hp','email','alamat','kesan','gambar','tglpost','id'); 
    private $column_search = array('status','nama','th_lulus','instansi','alamatins','hp','email','alamat','kesan','gambar','tglpost'); 
