...
class Pendidikan_model extends CI_Model
{
    ...
    {
        return $this->db->select('u.id_us,u.id_kurikulum,u.tertinggi,u.terendah,u.rata,u.id_tahun,m.mapel,m.is_active,t.tahun')->from('tb_rekap_us u')->join('tb_kurikulum m','u.id_kurikulum=m.id_kurikulum','left')->join('tb_tahun t','u.id_tahun=t.id_tahun','left')->where('u.id_tahun',$this->input->post('id_tahun',TRUE))->order_by('m.mapel','asc')->get();
    }
