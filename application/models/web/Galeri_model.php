...
class Galeri_model extends CI_Model {
    ...
    {
        return $this->db->select('f.id_foto,f.id_album,f.foto,f.uploaded_on,a.album,a.tgl,a.is_active,a.slug')->from('tb_foto f')->join('tb_album a','f.id_album=a.id_album','left')->where('a.is_active',1)->where('a.slug',$slug)->order_by('f.uploaded_on','desc')->get();
    }
