        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                    <a href="<?= base_url('backend/tambah-ekstrakurikuler'); ?>" class="btn bg-primary btn-flat"><i class="fa fa-plus"></i> Tambah Ekstrakurikuler</a>
                    ...
                    <div class="table table-responsive">
                        <table class="table table-bordered table-striped" id="example1">
                            ...
                            foreach($data->result() as $r):
                                ...
                                {
                                    $img = '<img src="'.base_url("assets/img/ekstrakurikuler/$r->gambar").'" class="img img-fluid">';;
                                }else
                                {
                                    $img = '';
                                }
                                ...
                                echo'<tr>
                                        ...
                                        <td class="text-center">
                                            <a href="'.base_url("backend/edit-ekstrakurikuler/$r->id").'" class="btn btn-dark btn-xs btn-flat" title="EDIT DATA">EDIT</a>
