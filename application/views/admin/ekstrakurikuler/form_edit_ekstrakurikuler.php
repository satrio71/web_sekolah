            ...
            <div class="card card-primary">
                ...
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="nama_ekstrakurikuler" maxlength="100" value="<?= $data->nama_ekstrakurikuler; ?>" class="form-control required" placeholder="NAMA EKSTRAKURIKULER">
                ...
                <div class="card-footer">
                  ...
                  <a href="<?= base_url('backend/ekstrakurikuler'); ?>" class="btn btn-danger btn-flat float-right"><i class="fa fa-arrow-left"></i> BATAL</a>
                </div>
              <?php echo form_close() ?>
            </div>
            <!-- /.card -->
