            ...
            <div class="card card-primary">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="nama_siswa" maxlength="100" value="<?= $data->nama_siswa; ?>" class="form-control" placeholder="NAMA SISWA">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">KELAS</label>
                        <div class="col-sm-3">
                            <input type="text" name="kelas" maxlength="6" value="<?= $data->kelas; ?>" class="form-control" placeholder="KELAS">
                        </div>
                    </div>
                    <div class="form-group row">
                ...
                <div class="card-footer">
                  ...
                  <a href="<?= base_url('backend/prestasi-siswa'); ?>" class="btn btn-danger btn-flat float-right"><i class="fa fa-arrow-left"></i> BATAL</a>
                </div>
              <?php echo form_close() ?>
            </div>
            <!-- /.card -->
