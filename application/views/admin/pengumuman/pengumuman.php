        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                    <a href="<?= base_url('backend/tambah-pengumuman'); ?>" class="btn bg-primary btn-flat"><i class="fa fa-plus"></i> Tambah Pengumuman</a>
                ...
                <div class="card-body">
                    <div class="table table-responsive">
                        <table class="table table-bordered table-striped" id="table-pengumuman">
