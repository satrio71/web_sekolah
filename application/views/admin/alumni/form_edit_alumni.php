            ...
            <div class="card card-primary">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-2">
                            <input type="number" name="jml_l" min="0" value="<?= $data->jml_l; ?>" class="form-control required">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-2">
                            <input type="number" name="jml_p" min="0" value="<?= $data->jml_p; ?>" class="form-control required">
