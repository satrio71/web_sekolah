        ...
        <div class="col-12">
            ...
            <div class="card card-primary">
                ...
                <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label"><?php if($profil->jenjang == 1 OR $profil->jenjang == 3){ echo'KELAS VII'; }else{ echo'KELAS X'; } ?> *</label>
                        <div class="col-sm-3">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label"><?php if($profil->jenjang == 1 OR $profil->jenjang == 3){ echo'KELAS VIII'; }else{ echo'KELAS XI'; } ?> *</label>
                        <div class="col-sm-3">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label"><?php if($profil->jenjang == 1 OR $profil->jenjang == 3){ echo'KELAS IX'; }else{ echo'KELAS XII'; } ?> *</label>
                        <div class="col-sm-3">
