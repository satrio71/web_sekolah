            ...
            <div class="card card-primary">
                ...
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="judul" maxlength="100" value="<?= $data->judul; ?>" class="form-control required" placeholder="JUDUL VIDEO">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <textarea name="keterangan" class="form-control" maxlength="200" placeholder="KETERANGAN VIDEO"><?= $data->keterangan; ?></textarea>
                            <?php echo form_error('keterangan'); ?>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">KODE VIDEO DARI YOUTUBE *</label>
                        <div class="col-sm-6">
                            <input type="text" name="link" maxlength="100" value="<?= $data->link; ?>" class="form-control required" placeholder="KODE VIDEO DARI YOUTUBE">
                  ...
                  <a href="<?= base_url('backend/video'); ?>" class="btn btn-danger btn-flat float-right"><i class="fa fa-arrow-left"></i> BATAL</a>
                </div>
              <?php echo form_close() ?>
            </div>
            <!-- /.card -->
