            ...
            <div class="card card-primary">
                ...
                <div class="card-body">
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">NAMA HALAMAN *</label>
                        <div class="col-sm-5">
                            <input type="text" name="nama" maxlength="100" value="<?= $data->nama; ?>" class="form-control required" placeholder="NAMA HALAMAN">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input type="url" name="link" value="<?= $data->link; ?>" class="form-control required" placeholder="LINK URL">
                ...
                <div class="card-footer">
                    ...
                    <a href="<?= base_url('backend/link-terkait'); ?>" class="btn btn-danger btn-flat float-right"><i class="fa fa-arrow-left"></i> BATAL</a>
                </div>
              <?php echo form_close() ?>
            </div>
            <!-- /.card -->
