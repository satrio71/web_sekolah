            ...
            <div class="card card-primary">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input type="text" name="duk" maxlength="30" value="<?= $data->duk; ?>" class="form-control" placeholder="DUK">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            ...
                            <div class="icheck-primary d-inline">
                                <input type="radio" name="statuspeg" value="GTT" id="radioPrimary3" <?php if($data->statuspeg == 'GTT'){ echo'checked'; } ?> > 
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <div class="icheck-primary d-inline">
                                <input type="radio" name="statusguru" value="Mapel" id="radioPrimary9" <?php if($data->statusguru == 'Mapel'){ echo'checked'; } ?> > 
                                <label for="radioPrimary9">Mapel</label> 
                                &nbsp;&nbsp;&nbsp; 
                            </div>
                            <div class="icheck-primary d-inline">
                                <input type="radio" name="statusguru" value="BP/BK" id="radioPrimary10" <?php if($data->statusguru == 'BP/BK'){ echo'checked'; } ?> > 
                                <label for="radioPrimary10">BP/BK</label> 
                                &nbsp;&nbsp;&nbsp; 
                            </div>
                            <div class="icheck-primary d-inline">
                                <input type="radio" name="statusguru" value="Kurikulum" id="radioPrimary11" <?php if($data->statusguru == 'Kurikulum'){ echo'checked'; } ?> > 
