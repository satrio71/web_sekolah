            ...
            <div class="card card-primary">
                ...
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <?php } ?>
                        <input type='file' class='form-control' name='struktur' onchange='readURL(this);' required>
                ...
                <div class="card-footer">
                  ...
                  <a href="<?= base_url('backend/struktur-organisasi'); ?>" class="btn btn-danger btn-flat float-right"><i class="fa fa-arrow-left"></i> BATAL</a>
                </div>
              <?php echo form_close() ?>
            </div>
            <!-- /.card -->
