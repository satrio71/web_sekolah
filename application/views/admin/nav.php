        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?= base_url('backend/profil-web'); ?>" class="<?php if($this->uri->segment('2') == 'profil-web' OR $this->uri->segment('2') == 'edit-profil-web' OR $this->uri->segment('2') == 'logo-web' OR $this->uri->segment('2') == 'favicon' OR $this->uri->segment('2') == 'gambar-profil' OR $this->uri->segment('2') == 'file') { echo 'nav-link active'; }else{ echo 'nav-link'; } ?>">
