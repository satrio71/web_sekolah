            ...
            <div class="card card-primary">
                ...
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input type="text" name="tahun" maxlength="10" value="<?= $data->tahun; ?>" class="form-control required" placeholder="TAHUN PELAJARAN">
                ...
                <div class="card-footer">
                  ...
                  <a href="<?= base_url('backend/tahun-pelajaran'); ?>" class="btn btn-danger btn-flat float-right"><i class="fa fa-arrow-left"></i> BATAL</a>
                </div>
              <?php echo form_close() ?>
            </div>
            <!-- /.card -->
