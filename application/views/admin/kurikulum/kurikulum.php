        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                    <a href="<?= base_url('backend/tambah-kurikulum'); ?>" class="btn bg-primary btn-flat"><i class="fa fa-plus"></i> Tambah Data</a>
                            ...
                            <?php $no=1; foreach($data->result() as $r): ?>
                                <tr>
                                    ...
                                    <td class="text-center" nowrap>
                                        <a href="<?= base_url(); ?>backend/edit-kurikulum/<?= $r->id_kurikulum; ?>" class="btn btn-dark btn-xs btn-flat" title="EDIT DATA">EDIT</a>
