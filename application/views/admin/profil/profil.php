                ...
                <div class="card-body">
                    <div class="col-md-12">
                        <div class="row mt-2">
                            ...
                            <div class="col-md-4"><a href="<?= base_url('backend/edit-profil-web'); ?>" class="btn btn-primary float-right btn-sm btn-flat"><i class="fa fa-edit"></i> EDIT PROFIL WEB</a></div>
                        </div>
                        <div class="row mt-2">
