        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                    <a href="<?= base_url('backend/tambah-album'); ?>" class="btn bg-primary btn-flat"><i class="fa fa-plus"></i> Tambah Album</a>
                            ...
                            foreach($data->result() as $r):
                                ...
                                echo'<tr>
                                        ...
                                        <td class="text-center" nowrap>
                                            <a href="'.base_url("backend/edit-album/$r->id_album").'" class="btn btn-dark btn-xs btn-flat" title="EDIT DATA">EDIT</a>
                                            <a href="javascript:void(0)" class="btn btn-danger btn-xs btn-flat text-white" data-toggle="modal" data-target="#konfirmasi_hapus" data-href="'.base_url("backend/hapus-album/$r->id_album").'" title="HAPUS DATA">HAPUS</a>
                                        </td>
                                    </tr>';
                            endforeach; 
                            ?>
