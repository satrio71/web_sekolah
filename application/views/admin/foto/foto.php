            ...
            <div class="card card-primary">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input type="file" name="files[]" accept='image/png, image/jpeg' class='form-control' required multiple/>
                ...
                <div class="card-footer">
                  <button type="submit" name="submit" value="Submit" class="btn btn-primary btn-flat"><i class="fa fa-check"></i> UPLOAD</button>
                </div>
              <?php echo form_close() ?>
            </div>
            <!-- /.card -->
            ...
            <div class="card">
                <div class="card-body">
                    <div class="table table-responsive">
                        <table class="table table-bordered table-striped" id="table-foto">
