        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                    <a href="<?= base_url('backend/tambah-user'); ?>" class="btn bg-primary btn-flat"><i class="fa fa-plus"></i> Tambah User</a>
                        ...
                        <table class="table table-bordered table-striped" id="example1">
                            ...
                            <tr>
                                ...
                                <td class="text-center" nowrap>
                                    <a href="<?= base_url("backend/edit-user/$r->id_user"); ?>" class="btn btn-dark btn-xs btn-flat" title="EDIT DATA">EDIT</a>
