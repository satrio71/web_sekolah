                ...
                <form method="GET" action="<?= base_url('agenda/search'); ?>">
                    <div class="input-group">
                        ...
                        <div class="input-group-append">
                            <button type="submit" class="btn bg-dark-slate-blue text-white"><i class="fa fa-search"></i></button>
                        </div>
                    </div>
                </form>
            </div>
                    ...
                    echo'<div class="col-md-4 text-break mt-4">
                            <div class="card h-100">
                                <div class="card-body p-1">
                                    ...
                                    <div class="card-desc">
                                        <h5>
                                            <a href="'.base_url("agenda/detail/$r->slug").'" class="text-decoration-none judul_link"><b>'.$r->nama_agenda.'</b>
                                        </h5>
                                        <table width="100%">
                                            <tr>
