    ...
    <div class="row">
        <div class="col-md-12">
            <table class="table table-bordered table-striped">
                <thead class="bg-dark-slate-blue text-white">
                    <tr>
                ...
                <tbody>
                    ...
                    echo'<tr>
                            <th width="5%" class="bg-dark-slate-blue text-white text-center">NO</th>
                            <th class="bg-dark-slate-blue text-white">KELOMPOK B</th>
                            <th class="bg-dark-slate-blue text-white"></th>
                        </tr>';
                    ...
                    echo'<tr>
                            <th width="5%" class="bg-dark-slate-blue text-white text-center">NO</th>
                            <th class="bg-dark-slate-blue text-white">KELOMPOK C</th>
                            <th class="bg-dark-slate-blue text-white"></th>
                        </tr>';
