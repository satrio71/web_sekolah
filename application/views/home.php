    ...
    foreach($banner->result() as $r):
        echo'<div style="max-height:600px">
                ...
                <div class="carousel-caption">
                    ...
                    if(!empty($r->link))
                    {
                        echo'<a href="'.$r->link.'" class="btn bg-warning border border-white btn-md"><b>'.$r->button.'</b></a>';
                    }
                echo'</div>
            </div>';
    endforeach;
...
<section class="details-card">
    <div class="container">
        <div class="row m-1 bg-white border">
            <div class="col-md-12 bg-dark-slate-blue text-white">
                        ...
                        foreach($album->result() as $r):
                            ...
                            echo'<div class="col-md-6 mb-3 mt-3 text-break">
                                    <div class="card h-100">
                                        ...
                                        <div class="card-body">
                                            <a href="'.base_url("galeri/album/$r->slug").'" class="card-text text-dark text-decoration-none"><b>'.$r->album.'</b></a>
                                        </div>
                        ...
                        foreach($video->result() as $r): 
                            echo'<div class="col-md-6 mb-3 mt-3 text-break">
                                    <div class="card h-100">
                                        ...
                                        <div class="card-body">
                                            <a href="https://www.youtube.com/embed/'.$r->link.'" target="_blank" class="card-text text-dark text-decoration-none"><b>'.$r->judul.'</b></a>
                                        </div>
                                        <div class="card-footer">
...
<section>
    <div class="container">
        <div class="row bg-white m-1 border">
            <div class="col-12 bg-dark-slate-blue text-white">
